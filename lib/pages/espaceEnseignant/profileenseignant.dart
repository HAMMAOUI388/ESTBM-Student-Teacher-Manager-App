              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildListItems('Identifiant : ',' $userId',  Icons.account_circle,  const Color.fromARGB(255, 2, 78, 140) ),
                    _buildListItems(  'Matricule : ',' $userMatricule', Icons.qr_code, const Color.fromARGB(255, 2, 78, 140)),
                    ...
                    _buildListItems('Email: ',' $userEmail', Icons.email,const Color.fromARGB(255, 2, 78, 140)),
